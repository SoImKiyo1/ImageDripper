...
for x in range(L):                                  # Itération pour chaque colonne
    ...
    for y in range(H):                              # Itération pour chaque pixel de la colonne
        ...
        r = pixel[0] + couleur       #Récupération de la composante rouge du pixel (RVB) dans la variable r
        v = pixel[1] + couleur       #Récupération de la composante verte du pixel (RVB) dans la variable v
        b = pixel[2] + couleur       #Récupération de la composante bleue du pixel (RVB) dans la variable b
...
image2.save("maNouvelleImagecdvferz.jpg")     #Enregistrement de l'image dans le même répertoire
